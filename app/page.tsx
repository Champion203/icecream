  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-1">รายได้</p>
        ...
        <Card className="bg-gradient-to-br from-red-50 to-red-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-1">ต้นทุน</p>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm mb-1">กำไร</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <Card>
          <h3 className="text-lg font-bold mb-4">สรุปต้นทุน-รายได้-กำไร</h3>
